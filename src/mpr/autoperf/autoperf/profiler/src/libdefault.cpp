...
{
  "PAPI_TOT_INS", //0
  "OFFCORE_RESPONSE_0:ANY_REQUEST:LLC_MISS_REMOTE_DRAM", start_perf_counters
...
// Intercept the pthread_join function. Thus, we are able to know that how many threads have exited.
